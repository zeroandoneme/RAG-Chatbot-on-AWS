...
from prompts import CONDENSE_QUESTION_PROMPT as QUESTION_PROMPT
...
class ConversationalRetrievalChain(BaseConversationalRetrievalChain):
    ...
    def from_llm(
        ...
        retriever: BaseRetriever,
        condense_question_prompt: BasePromptTemplate = QUESTION_PROMPT,
...
class ChatVectorDBChain(BaseConversationalRetrievalChain):
    ...
    def from_llm(
        ...
        **kwargs: Any,
        ...
        condense_question_chain = LLMChain(
            llm=llm, prompt=QUESTION_PROMPT, callbacks=callbacks
        )
        return cls(
            vectorstore=vectorstore,
            combine_docs_chain=doc_chain,
